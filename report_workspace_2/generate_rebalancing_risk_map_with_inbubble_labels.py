...
OUT_PATH = BASE_DIR / "chapter-07-discussion" / "images" / "C7_05_rebalancing_risk_map_inbubble_labels.png"
...
def main() -> None:
    ...
    df = pd.read_csv(CURSOR_DIR / "results_rebalancing_forecast.csv").copy()
