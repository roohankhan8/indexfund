...
REPORT_DIR = REPO_ROOT / "docs" / "report_workspace"

CH3_IMG = REPORT_DIR / "chapter-03-methodology" / "images"
CH4_IMG = REPORT_DIR / "chapter-04-data-collection-and-processing" / "images"
CH5_IMG = REPORT_DIR / "chapter-05-results-and-analysis" / "images"
CH6_IMG = REPORT_DIR / "chapter-06-portfolio-tilt-and-rebalancing-application" / "images"
CH7_IMG = REPORT_DIR / "chapter-07-discussion" / "images"
CH8_IMG = REPORT_DIR / "chapter-08-conclusion-and-recommendations" / "images"
GRAPH_EXPLAIN_DIR = REPORT_DIR / "graph_explanations"
...
def load_data():
    daily = pd.read_csv(ANALYSIS_DIR / "daily_master.csv", parse_dates=["date"])
    monthly = pd.read_csv(ANALYSIS_DIR / "monthly_master.csv", parse_dates=["date"])
    ff = pd.read_csv(ANALYSIS_DIR / "results_fund_flow.csv")
    garch = pd.read_csv(ANALYSIS_DIR / "results_garch.csv")
    eff = pd.read_csv(ANALYSIS_DIR / "results_efficiency.csv")
    reb = pd.read_csv(ANALYSIS_DIR / "results_rebalancing.csv")
    forecast = pd.read_csv(ANALYSIS_DIR / "results_rebalancing_forecast.csv")
    funds = pd.read_excel(RAW_DIR / "funds_data.xlsx", sheet_name=None)
    raw_stock = pd.read_csv(RAW_DIR / "kse30_daily_data.csv")
...
def sync_existing_report_figures() -> None:
    mappings = [
        (ANALYSIS_DIR / "figures" / "eda" / "E01_aum_trend.png", CH5_IMG / "E01_aum_trend.png"),
        (ANALYSIS_DIR / "figures" / "eda" / "E02_nav_return_dist.png", CH5_IMG / "E02_nav_return_dist.png"),
        (ANALYSIS_DIR / "figures" / "eda" / "E03_fund_flows.png", CH5_IMG / "E03_fund_flows.png"),
        (ANALYSIS_DIR / "figures" / "eda" / "E05_monthly_correlation.png", CH5_IMG / "E05_monthly_correlation.png"),
        (ANALYSIS_DIR / "figures" / "eda" / "E06_index_cumulative_return.png", CH5_IMG / "E06_index_cumulative_return.png"),
        (ANALYSIS_DIR / "figures" / "fund_flow" / "FF01_total_flow_predictions.png", CH5_IMG / "FF01_total_flow_predictions.png"),
        (ANALYSIS_DIR / "figures" / "fund_flow" / "FF02_granger.png", CH5_IMG / "FF02_granger.png"),
        (ANALYSIS_DIR / "figures" / "garch" / "G01_returns_and_vol.png", CH5_IMG / "G01_returns_and_vol.png"),
        (ANALYSIS_DIR / "figures" / "garch" / "G02_var_backtest.png", CH5_IMG / "G02_var_backtest.png"),
        (ANALYSIS_DIR / "figures" / "efficiency" / "EF01_acf.png", CH5_IMG / "EF01_acf.png"),
        (ANALYSIS_DIR / "figures" / "efficiency" / "EF02_variance_ratio.png", CH5_IMG / "EF02_variance_ratio.png"),
        (ANALYSIS_DIR / "figures" / "rebalancing" / "R01_retention_probability.png", CH6_IMG / "R01_retention_probability.png"),
        (ANALYSIS_DIR / "figures" / "rebalancing" / "R02_feature_importances.png", CH6_IMG / "R02_feature_importances.png"),
        (ANALYSIS_DIR / "figures" / "rebalancing" / "R03_weight_scatter.png", CH6_IMG / "R03_weight_scatter.png"),
        (ANALYSIS_DIR / "figures" / "rebalancing" / "R04_weight_changes.png", CH6_IMG / "R04_weight_changes.png"),
    ]
