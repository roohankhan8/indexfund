...
Input files read from sibling folder ../5_claude_pipeline/
...
Outputs (this directory): daily_master.csv, monthly_master.csv, results_*.csv, figures/

Run (from repo root):

   python 6_cursor_model/pipeline.py

Alternatively: python 6_cursor_model/run_pipeline.py
...
_SCRIPT_DIR = r'D:\roohan\fyp-indexfunds\7_codex_model'
_REPO_ROOT = os.path.dirname(_SCRIPT_DIR)
DATA_DIR = os.path.join(_SCRIPT_DIR, "data")
OUT_DIR = r'D:\roohan\fyp-indexfunds\_rerun_outputs\7_codex_model'
...
# â”€â”€ normalised company name map (SYMBOL -> clean name) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
COMPANY_MAP = {
...
# â”€â”€ 1a. KSE-30 constituent data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 1b. Per-symbol derived features â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 1c. Macro data â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 1d. Fund data (NAV + AUM) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Forward-fill macro to daily trading calendar â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ KSE-30 index-level aggregates (from constituent data) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ Daily master â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
print(f"Daily master: {len(daily):,} rows Ã— {len(daily.columns)} cols | "
...
# â”€â”€ Monthly master â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
print(f"Monthly master: {len(monthly):,} rows Ã— {len(monthly.columns)} cols | "
      f"{monthly.date.min().date()} -> {monthly.date.max().date()}")

# Save master datasets
daily.drop(columns=["month"]).to_csv(
    os.path.join(OUT_DIR, "rerun_daily_master.csv"), index=False
)
...
monthly_saved.to_csv(
    os.path.join(OUT_DIR, "rerun_monthly_master.csv"), index=False
)

# Save cleaned stock file
raw_out = raw.drop(columns=["weight_pct_clean"], errors="ignore")
raw_out.to_csv(os.path.join(OUT_DIR, "rerun_kse30_stocks_clean.csv"), index=False)
...
# â”€â”€ 3.1 Descriptive stats: KSE-30 index (reconstructed) daily log returns â”€â”€â”€â”€â”€
print("\n[Table] Descriptive statistics - Daily KSE-30 index log returns")
desc_rows = []
r_idx = daily["idx_log_return"].dropna().values
jb_s, jb_p = stats.jarque_bera(r_idx)
desc_rows.append({
    "Series": "KSE-30 (recon.)", "N": len(r_idx),
    "Mean %": round(r_idx.mean()*100, 4), "Std %": round(r_idx.std()*100, 4),
    "Min %":  round(r_idx.min()*100, 4),  "Max %": round(r_idx.max()*100, 4),
    "Skew":   round(float(stats.skew(r_idx)), 4),
    "ExKurt": round(float(stats.kurtosis(r_idx)), 4),
    "JB p":   round(jb_p, 6), "Normal": "No" if jb_p < 0.05 else "Yes",
})
desc_df = pd.DataFrame(desc_rows)
print(desc_df.to_string(index=False))

# â”€â”€ 3.2 Combined sector AUM (index-tracking funds) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
savefig("eda", "rerun_E01_aum_trend.png")

# â”€â”€ 3.3 Index return distribution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
fig, ax = plt.subplots(figsize=(7, 4))
s = daily["idx_log_return"].dropna()
ax.hist(s, bins=80, color=INDEX_COLOR, alpha=0.75, density=True, edgecolor="white")
x = np.linspace(s.quantile(0.01), s.quantile(0.99), 200)
ax.plot(x, stats.norm.pdf(x, s.mean(), s.std()), "k--", linewidth=1.2)
ax.set_title("KSE-30 daily log return - distribution\n"
             f"Î¼={s.mean():.4f}  Ïƒ={s.std():.4f}  skew={s.skew():.2f}")
ax.set_xlim(s.quantile(0.01), s.quantile(0.99))
plt.tight_layout()
savefig("eda", "rerun_E02_nav_return_dist.png")

# â”€â”€ 3.4 Composite net flows (inflows / outflows) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
ax.scatter(spikes["date"], spikes[col], color="black", s=45, marker="*",
           zorder=5, label="Spike >2Ïƒ (composite)")
...
fig.autofmt_xdate(rotation=30)
plt.tight_layout()
savefig("eda", "rerun_E03_fund_flows.png")

# â”€â”€ 3.5 Macro overview â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
fig.autofmt_xdate(rotation=30)
plt.tight_layout()
savefig("eda", "rerun_E04_macro_overview.png")

# â”€â”€ 3.6 Monthly correlation heatmap â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
corr_labels = ["Oil ret","USD/PKR ret","Int rate","CPI YoY",
               "KSE-30 ret","KSE-30 vol","Composite flow %"]
...
plt.tight_layout()
savefig("eda", "rerun_E05_monthly_correlation.png")

# â”€â”€ 3.7 KSE-30 index reconstructed return â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
fig, ax = plt.subplots(figsize=(13, 4))
...
fig.autofmt_xdate(rotation=30)
savefig("eda", "rerun_E06_index_cumulative_return.png")

# â”€â”€ 3.8 Top stocks by average weight â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
ax.set_title("Top 15 Stocks by Average KSE-30 Weight (2021â€“present)")
ax.set_ylabel("Avg weight (%)")
ax.set_xticklabels(avg_wts.index, rotation=45, ha="right")
plt.tight_layout()
savefig("eda", "rerun_E07_top_weights.png")
...
_IDX_NAME = "KSE-30"
_IDX_COL = "idx_log_return"
r  = daily[_IDX_COL].dropna().values * 100
dt = daily.loc[daily[_IDX_COL].notna(), "date"].values
print(f"\n  {_IDX_NAME} (reconstructed index) - GARCH(1,1) and EGARCH(1,1) ...")
...
garch_results[_IDX_NAME] = {"g11":g11,"eg11":eg11,"best":best,"returns":r,"dates":dt}
garch_rows.append({
    "Series": _IDX_NAME, "Model": "GARCH(1,1)",
...
pd.DataFrame(garch_rows).to_csv(
    os.path.join(OUT_DIR, "rerun_results_garch.csv"), index=False
)
print("\n  Saved: results_garch.csv")

# â”€â”€ GARCH figures â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
fig, axes = plt.subplots(1, 2, figsize=(14, 5))
fig.suptitle(
    'KSE-30 index - daily returns & conditional vol '
    f'({garch_results[_IDX_NAME]["best"]["model"]})',
    fontweight="bold",
)
r  = daily[_IDX_COL].dropna().values * 100
dt = daily.loc[daily[_IDX_COL].notna(), "date"].values
vol = np.sqrt(garch_results[_IDX_NAME]["best"]["sigma2"])
axes[0].fill_between(dt, r, alpha=0.5, color=INDEX_COLOR)
axes[0].axhline(0, color="black", linewidth=0.6)
axes[0].set_title("Daily log returns (%)")
axes[0].set_ylabel("Return (%)")
axes[1].plot(dt, vol, color=INDEX_COLOR, linewidth=1)
axes[1].set_title(
    f'{garch_results[_IDX_NAME]["best"]["model"]} conditional volatility (%)')
...
fig.autofmt_xdate(rotation=30)
plt.tight_layout()
savefig("garch", "rerun_G01_returns_and_vol.png")

# VaR backtest
fig, ax = plt.subplots(figsize=(13, 5))
r   = daily[_IDX_COL].dropna().values * 100
dt  = daily.loc[daily[_IDX_COL].notna(), "date"].values
var_line = stats.norm.ppf(0.05) * np.sqrt(garch_results[_IDX_NAME]["best"]["sigma2"])
exceed   = r < var_line
ax.fill_between(dt, r, 0, where=(r>=0), alpha=0.4, color=INDEX_COLOR)
ax.fill_between(dt, r, 0, where=(r<0), alpha=0.4, color="#e74c3c")
ax.plot(dt, var_line, color="black", linewidth=1, label="5% VaR")
ax.scatter(dt[exceed], r[exceed], color="black", s=8, zorder=5,
           label=f"Exc. ({exceed.sum()}, {exceed.mean()*100:.1f}%)")
ax.set_title(f'KSE-30 - {garch_results[_IDX_NAME]["best"]["model"]} 5% VaR backtest')
ax.legend(fontsize=8)
ax.xaxis.set_major_formatter(mdates.DateFormatter("%b'%y"))
ax.xaxis.set_major_locator(mdates.MonthLocator(interval=6))
fig.autofmt_xdate(rotation=30)
plt.tight_layout()
savefig("garch", "rerun_G02_var_backtest.png")
...
# â”€â”€ 5.1 Stationarity (ADF) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print("\n  ADF tests:")
...
# â”€â”€ 5.2 Granger causality â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 5.3 ARIMAX model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print("\n  ARIMAX(1,0,1) ...")
...
# â”€â”€ 5.4 VAR(1) model â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
print("  VAR(1) ...")
...
# â”€â”€ 5.5 Fund flow figures â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
ax.plot(dates_te, arimax_pred, "o-", color="#e74c3c", linewidth=2,
        markersize=5, label=f"ARIMAX (RÂ²={m_arimax['R2']:.3f})")
ax.plot(dates_te, np.array(var_preds), "s--", color="#2ca02c", linewidth=2,
        markersize=5, label=f"VAR(1) (RÂ²={m_var['R2']:.3f})")
...
ax.xaxis.set_major_locator(mdates.MonthLocator(interval=4))
fig.autofmt_xdate(rotation=30)
savefig("fund_flow", "rerun_FF01_total_flow_predictions.png")
...
plt.tight_layout()
savefig("fund_flow", "rerun_FF02_granger.png")
...
pd.DataFrame(ff_rows).to_csv(
    os.path.join(OUT_DIR, "rerun_results_fund_flow.csv"), index=False)
print("  Saved: results_fund_flow.csv")

print(f"\n  Model comparison:")
print(f"  {'Model':20s}  {'RMSE':>10}  {'RÂ²':>8}  {'DirAcc':>8}")
for r in ff_rows[:3]:
...
eff_rows = []
SER_EFF = "KSE-30"
_COL_EFF = "idx_log_return"
print(f"\n  {'Series':12s} {'Runs Z':>8} {'Runs p':>8} {'VR(2)':>7} "
      f"{'VR p':>7} {'LB p':>7} {'Hurst H':>9}")
print("  " + "-"*60)

r = daily[_COL_EFF].dropna().values
vr2 = vr_test(r, q=2, name=SER_EFF)
vr4 = vr_test(r, q=4, name=SER_EFF)
lb  = lb_test(r, lags=10, name=SER_EFF)
H   = hurst_exp(r, SER_EFF)
rt  = runs_test(r, SER_EFF)
print(f"  {SER_EFF:12s} {rt['Z']:>8.4f} {rt['p']:>8.4f} "
      f"{vr2['VR']:>7.4f} {vr2['p']:>7.4f} {lb['p']:>7.4f} "
      f"{H['H'] if H else np.nan:>9}")
eff_rows.append({
    "Series": SER_EFF, "N": len(r),
...
pd.DataFrame(eff_rows).to_csv(
    os.path.join(OUT_DIR, "rerun_results_efficiency.csv"), index=False)

# Sub-period analysis
print("\n  Sub-period (high-rate Apr 2022â€“Dec 2023 vs low-rate):")
high = (daily["date"]>="2022-04-01")&(daily["date"]<="2023-12-31")
low  = ~high
rh = daily.loc[high, _COL_EFF].dropna().values
rl = daily.loc[low, _COL_EFF].dropna().values
vr_h = vr_test(rh, q=2); vr_l = vr_test(rl, q=2)
Hh = hurst_exp(rh); Hl = hurst_exp(rl)
print(f"  {SER_EFF}: VR(2) high-rate={vr_h['VR']:.4f} "
      f"low-rate={vr_l['VR']:.4f} | "
      f"H high={Hh['H'] if Hh else float('nan'):.4f} "
      f"low={Hl['H'] if Hl else float('nan'):.4f}")

# Efficiency figures
fig, ax = plt.subplots(figsize=(8, 4))
fig.suptitle("ACF - KSE-30 daily index log returns", fontweight="bold")
r_acf = daily[_COL_EFF].dropna().values
n = len(r_acf)
ci = 1.96 / np.sqrt(n)
acf_v = [np.corrcoef(r_acf[k:], r_acf[:-k])[0, 1] for k in range(1, 21)]
colors = ["#e74c3c" if abs(v) > ci else INDEX_COLOR for v in acf_v]
ax.bar(range(1, 21), acf_v, color=colors, alpha=0.8)
ax.axhline(ci, color="black", linewidth=0.8, linestyle="--")
ax.axhline(-ci, color="black", linewidth=0.8, linestyle="--")
ax.axhline(0, color="black", linewidth=0.4)
row0 = eff_rows[0]
ax.set_title(f"{SER_EFF}  LB p={row0['LB Q p']:.4f}  ACFâ‚={row0['ACF lag-1']:.4f}")
ax.set_xlabel("Lag")
plt.tight_layout()
savefig("efficiency", "rerun_EF01_acf.png")

fig, ax = plt.subplots(figsize=(8, 5))
vrs = [vr_test(r_acf, q)["VR"] for q in [2, 4, 8, 16]]
ax.plot([2, 4, 8, 16], vrs, marker="o", color=INDEX_COLOR,
        linewidth=1.5, label=SER_EFF)
ax.axhline(1.0, color="black", linewidth=1.2, linestyle="--", label="VR=1 (RW)")
ax.set_xlabel("q")
ax.set_ylabel("VR(q)")
ax.set_title("Variance ratio - KSE-30 index returns")
ax.legend()
ax.set_xticks([2, 4, 8, 16])
plt.tight_layout()
savefig("efficiency", "rerun_EF02_variance_ratio.png")
...
# â”€â”€ 7.1 Detect rebalancing dates from composition changes â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 7.2 Build panel â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 7.3 Feature stats: retained vs dropped â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 7.4 Train/test split & models â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 7.5 Forward prediction: next rebalancing â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
# â”€â”€ 7.6 Rebalancing figures â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
plt.tight_layout()
savefig("rebalancing", "rerun_R01_retention_probability.png")
...
plt.tight_layout()
savefig("rebalancing", "rerun_R02_feature_importances.png")
...
ax.set_title(f"Weight Prediction - Test Set\nRidge RÂ²={m_ridge_wt['R2']:.4f}")
plt.tight_layout()
savefig("rebalancing", "rerun_R03_weight_scatter.png")
...
plt.tight_layout()
savefig("rebalancing", "rerun_R04_weight_changes.png")
...
pd.DataFrame(reb_rows).to_csv(
    os.path.join(OUT_DIR, "rerun_results_rebalancing.csv"), index=False)
future_df.to_csv(
    os.path.join(OUT_DIR, "rerun_results_rebalancing_forecast.csv"), index=False)
...
print("\n[Table 1] Descriptive statistics - Daily KSE-30 returns")
print(desc_df.to_string(index=False))
...
fig.suptitle("KSE-30 index - sector flows & constituent rebalancing (dashboard)",
             fontsize=14, fontweight="bold", y=0.98)
gs = fig.add_gridspec(2, 3, hspace=0.4, wspace=0.35)

# Panel 1: GARCH persistence (KSE-30 index)
ax1 = fig.add_subplot(gs[0, 0])
p1 = float(garch_rows[0]["persist"])
c1 = "#e74c3c" if p1 > 0.95 else "#f39c12" if p1 > 0.90 else "#2ecc71"
ax1.bar(["KSE-30"], [p1], color=c1, alpha=0.85)
ax1.axhline(1.0, color="black", linewidth=1.2, linestyle="--")
ax1.axhline(0.95, color="orange", linewidth=0.8, linestyle=":")
ax1.set_ylim(0, 1.05)
ax1.set_title("GARCH(1,1)\nPersistence (Î±+Î²)")
ax1.text(0, p1 + 0.005, f"{p1:.3f}", ha="center", fontsize=9)
...
ax2.set_title("Sector flow prediction\nDirectional accuracy (%)")
...
# Panel 3: efficiency test summary (KSE-30)
...
ax3.bar(x, vals, color=INDEX_COLOR, alpha=0.85)
ax3.set_xticks(x)
ax3.set_xticklabels(test_labels, fontsize=8)
ax3.set_yticks([0, 1])
...
savefig("summary", "rerun_SUMMARY_dashboard.png")
